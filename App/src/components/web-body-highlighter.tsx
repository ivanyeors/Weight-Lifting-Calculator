...
// Front assets
import { ReactComponent as FrontHead } from '@/assets/body-vector/front-body/Head.svg'
import { ReactComponent as FrontHands } from '@/assets/body-vector/front-body/hands.svg'
import { ReactComponent as FrontDeltoids } from '@/assets/body-vector/front-body/Deltoids.svg'
import { ReactComponent as FrontBiceps } from '@/assets/body-vector/front-body/Biceps.svg'
import { ReactComponent as FrontChest } from '@/assets/body-vector/front-body/Chest.svg'
import { ReactComponent as FrontAbs } from '@/assets/body-vector/front-body/Rectus Abdominis.svg'
import { ReactComponent as FrontObliques } from '@/assets/body-vector/front-body/Obliques.svg'
import { ReactComponent as FrontTrapezius } from '@/assets/body-vector/front-body/Trapezius.svg'
import { ReactComponent as FrontForearms } from '@/assets/body-vector/front-body/Forearms.svg'
import { ReactComponent as FrontQuads } from '@/assets/body-vector/front-body/Quadriceps.svg'
import { ReactComponent as FrontLowerLegs } from '@/assets/body-vector/front-body/Lower Legs.svg'
import { ReactComponent as FrontNeck } from '@/assets/body-vector/front-body/Neck.svg'

// Back assets
import { ReactComponent as BackHead } from '@/assets/body-vector/back-body/Vector.svg'
import { ReactComponent as BackHands } from '@/assets/body-vector/back-body/Hands.svg'
import { ReactComponent as BackTraps } from '@/assets/body-vector/back-body/Traps.svg'
import { ReactComponent as BackTriceps } from '@/assets/body-vector/back-body/Triceps.svg'
import { ReactComponent as BackUpperBack } from '@/assets/body-vector/back-body/Upper Back.svg'
import { ReactComponent as BackLowerBack } from '@/assets/body-vector/back-body/Lower Back.svg'
import { ReactComponent as BackGlutes } from '@/assets/body-vector/back-body/Glutes.svg'
import { ReactComponent as BackHamstrings } from '@/assets/body-vector/back-body/Hamstrings.svg'
import { ReactComponent as BackCalves } from '@/assets/body-vector/back-body/Calves.svg'
import { ReactComponent as BackForearms } from '@/assets/body-vector/back-body/Forearms.svg'
  import { ReactComponent as BackShoulders } from '@/assets/body-vector/back-body/Shoulders.svg'
